...
validation:
  ...
  evidence:
    ...
    - kind: deployment
      ref: null
      date: null
      notes: "Zod schema + PedagogyContractPage.astro renderer + tdr_traceability CI hook pending follow-up PRs."
  notes: "Schema + reference docs are stable; runtime renderer + audit invariants land in follow-up work."
---
