...
| [docs/website/decisions/0055-squash-merge-for-code-prs.md](/squash-merge-for-code-prs/) | validated | 2026-05-16 | deployment, manual | Process contract; validated by observed behavior on every code PR (#43, #44, #49, #50, #51, #52). No automated enforcement, but no violations observed. |
