...
|---|---|---|---|
| **D / E / F / C / O / K** | [0038](../decisions/0038-pedagogy-index-pattern.md) (Bucket C) | [chapter-components](../reference/chapter-components.md) | Pedagogy-index integrity: dangling `<EquationRef>`/`<FigureRef>`/`<GlossaryTerm>`/`<ChapterRef>` (D4/D5, E4, F2, C1), required titles (E1/F1, K1), unused anchors (E6, F4, O1/O2). 10 invariants. |
