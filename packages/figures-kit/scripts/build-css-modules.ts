...
// Builds CSS Module wrappers for @sophie/figures-kit.
//
// Mirrors @sophie/components/scripts/build-css-modules.ts (the kit
// uses the same dist-emit pattern + companion .module.css.js shims +
// bundled dist/styles.css). Per-package self-contained for now; a
// shared monorepo tooling location can extract this if/when a 3rd
// consumer materializes (DRY-when-paid per ADR 0023).
...
const bundleParts: string[] = [
  "/* @sophie/figures-kit — bundled component stylesheets.",
  " * Generated by scripts/build-css-modules.ts. Do not edit by hand.",
  " * Side-effect-imported alongside @sophie/components/styles.css.",
  " */",
  "",
];
for (const r of results) {
